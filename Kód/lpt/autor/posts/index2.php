        ...
        <?php include(ROOT_PATH . "/app/includes/dashboardSidebar.php"); ?>
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Recenze</h2>
                        ...
                        <tbody>
							...
							?>
                                <tr>
                                    ...
                                    <td><a href="display_submitted_recenze_single.php?id=<?php echo $post['id']; ?>&verze=<?php echo $post['verze']; ?>&recenzent_id=<?php echo $post['recenzent_id']; ?>" class="display">zobrazit</a></td>
