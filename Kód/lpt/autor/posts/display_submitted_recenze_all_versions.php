      ...
      <div class="main-content-wrapper">
        <div class="main-content single">
          ...
          <div class="post-content">
			...
			$results_3 = mysqli_query($conn," SELECT * FROM users, posts_vybrani_recenzenti WHERE users.id='$recenzent_id' AND posts_vybrani_recenzenti.verze='$postVERZE' AND posts_vybrani_recenzenti.id='$id' AND posts_vybrani_recenzenti.zpristupneno_autorovi='1' GROUP BY posts_vybrani_recenzenti.id");
			while ($recenzent = mysqli_fetch_assoc($results_3)) {
			
				echo "<br><br><div align='right'>Jméno recenzenta: " . $recenzent['username'] . "</div><br>";
			}	
			
			$results_4 = mysqli_query($conn," SELECT * FROM posts_recenze WHERE posts_recenze.verze='$postVERZE' AND posts_recenze.id='$id' AND posts_recenze.recenzent_id='$recenzent_id'");
