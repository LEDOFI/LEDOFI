      ...
      <div class="main-content-wrapper">
        <div class="main-content single">
          ...
          <div class="post-content">
	        ...
	        $results_2 = mysqli_query($conn," SELECT * FROM posts_autors WHERE posts_autors.id='$id' AND posts_autors.verze='$postVERZE' AND posts_recenze.recenzent_id='$sessionid'
			...
			$results_3 = mysqli_query($conn," SELECT * FROM users, posts_vybrani_recenzenti WHERE users.id='$recenzent_id' AND posts_vybrani_recenzenti.verze='$postVERZE' AND posts_vybrani_recenzenti.id='$id' AND posts_recenze.recenzent_id='$sessionid'
			                                GROUP BY posts_vybrani_recenzenti.id"); // select query
