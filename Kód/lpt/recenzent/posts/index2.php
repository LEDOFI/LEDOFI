...
<html lang="en">
    ...
    <head>
        ...
        <title>Redaktor - Spravovat recenze ke kontrole</title>
    </head>
        ...
        <?php include(ROOT_PATH . "/app/includes/dashboardSidebar.php"); ?>
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Spravovat recenze (jednotlivé)</h2>
                    ...
                    <table>
                        ...
                        <tbody>
							<?php
								...
								$sql = "SELECT * FROM posts, posts_assets, posts_recenze, posts_vybrani_recenzenti 
										WHERE posts.id=posts_assets.id AND posts.id=posts_recenze.id AND posts.id=posts_vybrani_recenzenti.id AND posts_assets.verze=posts_recenze.verze AND posts_assets.verze=posts_vybrani_recenzenti.verze AND posts_recenze.recenzent_id='$sessionid' AND posts_vybrani_recenzenti.recenzent_id='$sessionid'
							...
							?>
                                <tr>
                                    ...
                                    <td><a href="display_submitted_recenze_single.php?id=<?php echo $post['id']; ?>&verze=<?php echo $post['verze']; ?>" class="display">zobrazit</a></td>
