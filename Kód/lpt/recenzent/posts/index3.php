        ...
        <?php include(ROOT_PATH . "/app/includes/dashboardSidebar.php"); ?>
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Spravovat recenze (seskupené)</h2>
